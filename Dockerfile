...
LABEL USER-INSTALL="/usr/bin/podman run --env IMAGE=IMAGE --privileged --rm -v \${PWD}/:/host IMAGE /bin/bash /container/label-install"
LABEL UNINSTALL="/usr/bin/podman run --rm --privileged -v /:/host IMAGE /bin/bash /container/label-uninstall"
LABEL USER-UNINSTALL="/usr/bin/podman run --rm --privileged -v \${PWD}/:/host IMAGE /bin/bash /container/label-uninstall"
